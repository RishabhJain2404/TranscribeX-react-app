  ...
  return (
    <main className="flex-1  p-4 flex flex-col gap-3 text-center sm:gap-4  justify-center pb-20">
      ...
      <h3 className="font-medium md:text-lg">
        Record <span className="text-purple-700">&rarr;</span> Transcribe{" "}
        <span className="text-purple-700">&rarr;</span> Translate
      </h3>
      <button
        onClick={
      ...
      <p className="text-base">
        Or{" "}
        <label className="text-purple-400 cursor-pointer hover:text-purple-700 duration-200">
          upload{" "}
          <input
            onChange={(e) => {
